  ...
  return (
    <div className="check-box-section filter-section">
      ...
      <CheckBox
        ...
        dataType={filterProperties.class}
        text={text1}
        dataValue={filterPropertyValues.class.option_1}
      />
      <CheckBox
        generateUrl={generateUrl}
        dataType={filterProperties.class}
        text={text2}
        dataValue={filterPropertyValues.class.option_2}
      />
      <CheckBox
        generateUrl={generateUrl}
        dataType={filterProperties.class}
        text={text3}
        dataValue={filterPropertyValues.class.option_3}
      />
    </div>
  );
};
